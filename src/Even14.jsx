...
const Even14 = () => {
    ...
    const getData = async () => {
        try {
            const response = await axios.get('https://a67474a4e6e67b1c.mokky.dev/Even_14')
    ...
    const handleStatus = async (id, status) => {
        try {
            const response = await axios.patch(`https://a67474a4e6e67b1c.mokky.dev/Even_14/${id}`, {
                status: status,
            })
    ...
    const handleAdd = (e) => {
        ...
        const postData = async () => {
            try {
                const response = await axios.post('https://a67474a4e6e67b1c.mokky.dev/Even_14', {
                    name,
                    status: false,
                })
    ...
    const handleDelete = async (id) => {
        try {
            const response = await axios.delete(`https://a67474a4e6e67b1c.mokky.dev/Even_14/${id}`)
